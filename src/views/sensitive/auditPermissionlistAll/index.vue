    ...
    <el-card class="content-spacing">
      <tool-bar @handleExport="doExport" :msg="`共${pageConfig.total}个客户`">
        <div slot="right">
          ...
          <el-t-button type="primary">批量通过</el-t-button>
          <el-t-button type="primary">批量拒绝</el-t-button>
        </div>
      </tool-bar>
    </el-card>
    ...
    <el-card class="content-spacing">
      <div>
        ...
        >
          ...
          <el-table-column label="角色名称" align="left"></el-table-column>
          <el-table-column label="提交人" align="left"></el-table-column>
          <el-table-column label="获取权限" align="left"></el-table-column>
          <el-table-column label="内容" align="left"></el-table-column>
          <el-table-column label="提交时间" align="left"></el-table-column>
          <el-table-column label="审核状态" align="left"></el-table-column>
