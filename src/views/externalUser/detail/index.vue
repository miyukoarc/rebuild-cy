            ...
            >
              ...
              >
                ...
                <el-t-button
                  ...
                  @click.native="handleGroupRouter(item)"
                >查看</el-t-button>
              </div>
              <!-- </transition-group> -->
...
export default {
  ...
  watch: {
    ...
    //   handler(newVal, oldVal) {
    //     if (newVal != 'undefined') {
    //       this.initExternalUserData(newVal)
    //     }
    //   },
    // },
  },
  ...
  created() {
    // this.initExternalUserData(this.$route.params.uuid);
  },
  mounted() {
  ...
  methods: {
    // 初始化详情数据
    initExternalUserDetail(payload) {
      this.$store
    ...
    initExternalUserData(paramsUuid) {
      if (paramsUuid) {
        const uuid = paramsUuid;
        this.query.uuid = paramsUuid;
        this.initExternalUserDetail(paramsUuid);
